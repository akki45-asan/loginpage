...
$(document).ready(function () {
    // var is_rework = getUrlParameter("rework");
...
//   console.log(pType)
   ...
   $('#table tbody tr').each(function() {
    ...
    $(document).on('click','#table tbody tr .getildMails', function () {
    ...
    [
        {
            ...
            "message": "On Tower-hill, as you go down",
            "attachmentIcon": "<i class='icon-attachment icon-1x'></i>",
            "actions": "<div class='list-icons'><div class='dropdown'><a href='#' class='list-icons-item' data-toggle='dropdown'><i class='icon-menu9'></i></a><div class='dropdown-menu dropdown-menu-right'><a href='#' class='dropdown-item' data-toggle='modal' data-target='#tagMail_modal'><i class='icon-price-tag3 icon-1x tag' data-toggle='tooltip'title='Tag Mail' data-placement='left' ></i>Tag Mail</a><a href='#' class='dropdown-item irrelevant-mail' data-toggle='modal' data-target='#irrelevantMail_model'><i class='icon-cross icon-1x ' data-toggle=' tooltip'title='Irrelevant mail' data-placement='right'></i>Irrelevant Mail</a><a href='#' class='dropdown-item' data-toggle='modal' data-target='#addRequirement_model'><i class='icon-eye icon-1x' data-tooltip='tooltip' title='View Mail' data-original-title='View Mail' data-placement='top'></i>View Mail</a><a href='#' class='dropdown-item' data-toggle='modal' data-target='#modal_Recall'><i class='icon-reset icon-1x' data-toggle='tooltip' title='Recall'></i>Recall</a></div></div></div>",
            "timestamp": "2020-29-02 03:30:00",
            "count": 2,
            "readFlag":"Y"
        },
...
function actionFormatter(value, row, index) {
	var actionStr;
	actionStr = '<div class="list-icons">';
	actionStr += '<div class="dropdown">';
	actionStr += '<a href="#" class="list-icons-item" data-toggle="dropdown"><i class="icon-menu9"></i></a>';
	actionStr += '<div class="dropdown-menu dropdown-menu-right">';
	actionStr += '<a href="TagMailPopup.html?tagMail=true" class="dropdown-item"><i class="icon-price-tag3 icon-1x tag" data-toggle="tooltip"title="Tag Mail" data-placement="left"></i>Tag Mail</a>';
	actionStr += '<a href="composeMailPopup.html?composeMail=true" class="dropdown-item"><i class="icon-pencil7 icon-1x" data-toggle="tooltip"title="Compose For Regulator" data-placement="right"></i>Compose For Regulator</a>';
	actionStr += '<a href="irrelevantMailPopup.html?irrelevantMail=true" class="dropdown-item irrelevant-mail"><i class="icon-cross icon-1x" data-toggle="tooltip" title="Irrelevant mail" data-placement="right"></i>Irrelevant Mail</a>';
	actionStr += '<a href="initiateQueryPopup.html?initiateQuery=true" class="dropdown-item"><i class="icon-eye icon-1x" data-tooltip="tooltip" title="View Mail" data-original-title="View Mail" data-placement="top"></i>View Mail</a>';
	actionStr += '<a href="setEscalationPopup.html?setEscalation=true" class="dropdown-item"><i class="fas fa-asterisk fa-1x" data-toggle="tooltip" title="Escalation"></i>Escalation</a>';
	actionStr += '<a href="#" class="dropdown-item"><i class="icon-mail-read icon-1x" data-toggle="tooltip" title="Reopen"></i>Reopen</a>';
	actionStr += '<a href="modal_RecallPopup.html?recallModal=true" class="dropdown-item"><i class="icon-reset icon-1x" data-toggle="tooltip" title="Recall"></i>Recall</a>';
	actionStr += '<a href="viewMailPopup.html?viewMail=true" class="dropdown-item"><i class="icon-eye icon-1x" data-tooltip="tooltip" title="View Mail" data-original-title="View Mail" data-placement="top"></i>View Mail</a>'
	actionStr += '</div>';
	actionStr += '</div>'
	actionStr += '</div>';
