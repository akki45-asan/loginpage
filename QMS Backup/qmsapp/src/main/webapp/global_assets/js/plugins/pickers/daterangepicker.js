                ...
                '<div class="ranges">' +
                    '<div class="daterangepicker-inputs">' +
                        '<div class="daterangepicker_input">' +
                            ...
                            '<input class="form-control" type="text" name="daterangepicker_start" value="" onfocus="showstartCalander()"/>' +
                            '<i class="icon-calendar3"></i>' +
                        '</div>' +
                        '<div class="daterangepicker_input">' +
                            '<span class="end-date-label"></span>' +
                            '<input class="form-control" type="text" name="daterangepicker_end" value="" onfocus="showendCalander()"/>' +
                            '<i class="icon-calendar3"></i>' +
                        '</div>' +
                    '</div>' +
...
// function myfunction() {
// $('.daterangepicker .calendars .calendar.left').hide();
// $('.daterangepicker .calendars .calendar.right').hide();
// };
// function showstartCalander() {
//     $('.daterangepicker .calendars .calendar.left').show();
// }

// function showendCalander() {
//     $('.daterangepicker .calendars .calendar.right').show();
// }